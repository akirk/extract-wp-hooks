...
{
	private function extractCommentFromFile($filePath)
	{
	...
	{
		$filePath = __DIR__ . '/fixtures/docblock_simple.php';
		$comment = $this->extractCommentFromFile($filePath);
		$result = parse_docblock($comment, []);
	...
	{
		$filePath = __DIR__ . '/fixtures/docblock_single_line.php';
		$comment = $this->extractCommentFromFile($filePath);
		$result = parse_docblock($comment, []);
	...
	{
		$filePath = __DIR__ . '/fixtures/docblock_multi_line.php';
		$comment = $this->extractCommentFromFile($filePath);
		$result = parse_docblock($comment, []);
	...
	{
		$filePath = __DIR__ . '/fixtures/docblock_documented_in.php';
		$comment = $this->extractCommentFromFile($filePath);
		$result = parse_docblock($comment, []);
